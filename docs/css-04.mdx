...
<Codepen hash="ZrWEEK" user="borisrorsvort" themeId="light" />
...
<Codepen hash="KQzKwg" user="borisrorsvort" themeId="light" />
...
<div class="video">
  <iframe
    width="560"
    height="315"
    src="https://www.youtube-nocookie.com/embed/j1T9oq5OgR8"
    frameborder="0"
...
<Codepen hash="VQawzN" user="borisrorsvort" themeId="light" />
...
<Codepen hash="MQyWrO" user="borisrorsvort" themeId="light" />
...
<Codepen hash="OmNxMj" user="borisrorsvort" themeId="light" />
...
<Codepen hash="EPYpPW" user="borisrorsvort" themeId="light" />
